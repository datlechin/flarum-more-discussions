...
var prefix = 'datlechin-more-discussions';
var settingPrefix = prefix + '.';
var localePrefix = prefix + '.admin.settings.';
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('datlechin/flarum-more-discussions', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"](prefix).registerSetting({
...
function trans(key) {
  return flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans(localePrefix + key);
}
